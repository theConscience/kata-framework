/* global GLOBAL_SETTINGS, PRESENTATION_UTILS_MODULE */
...
(function(settings, presentation_utils) {
  ...
  var initUploadablePartners = function() {
    ...
    if (!uploadablePartners) return false;
    ...
    */
    ...
    var onUploadablePartnersLoadButtonClick = function(evt) {
      ...
      presentation_utils.$uploadablePartnersLoad(uploadablePartners,
  ...
  var initUploadableClientsReplies = function() {
    ...
    if (!uploadableClientsReplies) return false;
    ...
    */
    ...
    var onUploadableClientsRepliesLoadButtonClick = function(evt) {
      ...
      presentation_utils.$uploadableClientsRepliesLoad(uploadableClientsReplies,
  ...
  var initBackToTopButton = function() {
    ...
    if (!backToTopButton) return false;
  ...
  var initCompanyTypeMenuToggle = function() {
    ...
    if (!companyTypeMenu) return false;
  ...
  var initCompanyTypeMenuScroll = function() {
    ...
    if (!companyTypeMenuPanel) return false;
  ...
  var initVideoModal = function() {
    var videoModal = document.querySelector('.modal--presentation-video');
    if (!videoModal) return false;
    var videoModalOpenButton = document.querySelector('.video-block__play-button');
    if (!videoModalOpenButton) return false;
...
})(GLOBAL_SETTINGS, PRESENTATION_UTILS_MODULE);
